export default {
  ...
  getSocialLoginUrl: function (socialType) {
    return `${
      import.meta.env.VITE_SERVER_API_URL
    }/oauth2/authorization/${socialType}?redirect_uri=${import.meta.env.VITE_SERVER_REDIRECT_URL}`
  },
  getSocialImage: function (socialType) {
    switch (socialType) {
      case 'google':
